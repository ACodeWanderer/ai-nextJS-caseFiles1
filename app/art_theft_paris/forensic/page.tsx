  ...
  exhibits: [
    {
      exhibit_id: "EXH-001",
      item_description:
        "A section of security wire, approximately 3mm in diameter, severed with a clean, precise cut.",
      collection_location:
        "Floor beneath the empty frame, Renaissance wing, Louvre Museum.",
      ...
      available_analyses: [
        {
          ...
          results: {
            summary:
              "Metallurgical analysis shows no trace metal shearing, characteristic of pressure cutters. The cut surface is smooth, suggesting a high-temperature thermal or advanced ceramic blade. This indicates a sophisticated, non-standard tool was used.",
            is_conclusive: true,
          },
        },
      ],
    },
    {
      exhibit_id: "EXH-002",
      item_description:
        "Three latent fingerprints lifted from the lower-left corner of the glass display case that housed the painting.",
      collection_location:
        "Glass display case, Renaissance wing, Louvre Museum.",
      ...
      available_analyses: [
        {
          ...
          results: {
            summary:
              "Automated Fingerprint Identification System (AFIS) comparison returned no matches to known criminals or museum staff. The prints are degraded, suggesting they are not recent or were partially wiped.",
            is_conclusive: false,
          },
        },
      ],
    },
    {
      exhibit_id: "EXH-003",
      item_description:
        "One microscopic paint chip (approx. 500 micrometers) with a distinct dark red and yellow layering.",
      collection_location:
        "On the floor near the gallery's east wall, approximately 4 meters from the crime scene.",
    ...
    },
    {
      exhibit_id: "EXH-004",
      item_description:
        "A small, high-quality linen cardstock left inside the empty frame. A single sentence is written in elegant script.",
      collection_location:
        "Inside the empty frame of 'La Belle Ferronnière', Renaissance wing.",
      contamination_risk: "LOW",
      available_analyses: [
        {
          analysis_id: "UVS-001",
          ...
          results: {
            summary:
              "Ultraviolet scanning reveals a faint watermark: the logo of 'Montmartre Fine Art Supplies,' a specialty shop known for supplying restoration and forgery materials. This suggests the perpetrator has interests not only in stealing art but potentially in creating it as well.",
            is_conclusive: true,
          },
        },
      ],
...
const sceneData = [
  {
    ...
    exhibits: forensicCaseFile.exhibits.map((exhibit) => ({
      name: `Exhibit ${exhibit.exhibit_id}: ${
        exhibit.item_description.split(",")[0]
      }`,
  ...
  ...forensicCaseFile.exhibits.flatMap((exhibit) => [
    {
      ...
      narration: `Forensic analysis of Exhibit ${
        exhibit.exhibit_id
      } is complete. The findings from the ${exhibit.available_analyses[0].analysis_type.replace(
        "_",
        " "
      )} are detailed below.`,
      analysis: exhibit,
  ...
  ]),
  {
    ...
    narration:
      "All available analyses have been concluded. The cumulative evidence provides a strong forensic profile. The use of a sophisticated cutting tool (EXH-001) and meticulous cleaning of fingerprints (EXH-002) indicate a professional with technical knowledge. The watermark on the calling card (EXH-004) suggests a connection to the world of art forgery. However, the most conclusive piece of evidence is the paint chip (EXH-003). Its unique composition provides a direct material link between the crime scene and art dealer Vincent Delacroix, who has a known history and motive related to the specific artwork matched by the sample. The forensic evidence strongly indicates that Vincent Delacroix is a primary person of interest in this theft.",
    options: [
      {
    ...
    <>
      ...
      <style jsx>{`
        ...
        .clue-status.verified {
          background: #ca8a04; /* A slightly darker gold for verified */
        }
        ...
        .previous-scene-button:hover {
          background: #fef3c7;
          color: #7f1d1d;
          box-shadow: 0 0 20px rgba(254, 243, 199, 0.5);
          transform: scale(1.05);
        }
