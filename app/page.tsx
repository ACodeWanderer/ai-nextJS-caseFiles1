    ...
    <div className="relative h-screen w-full flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center gap-7 text-center h-screen animate-fadeIn">
        ...
        <Link href="/welcome" className="mt-12">
          <button className="bg-[#8c52ff] text-white px8 py-2 px-4 rounded-full text-lg md:text-xl font-bold uppercase tracking-[2px] cursor-pointer transition-all duration-300 flex items-center gap-3 shadow-[0_0_15px_#8c52ff] hover:bg-[#a875ff] hover:scale-105 hover:shadow-[0_0_25px_#c79cff]">
