  ...
  exhibits: [
    {
      exhibit_id: "EXH-001",
      item_description:
        "A company-issued laptop, recovered from the victim's desk. The screen is active, showing a half-written email.",
      ...
      available_analyses: [
        {
          ...
          results: {
            summary:
              "Fingerprints from the victim, Marcus Blackwell, are prevalent. However, a clear print belonging to his assistant, Lisa Wong, was found on the 'delete' key. The computer's system logs, timestamped after the victim's death, show an attempt to permanently erase several financial files. Digital recovery of these files revealed an email draft detailing a £2.3 million embezzlement scheme traced to Lisa Wong.",
            is_conclusive: true,
          },
        },
      ],
    },
    {
      exhibit_id: "EXH-002",
      item_description:
        "A network-enabled 'Ember' smart coffee mug, half-full with a cold, dark liquid.",
    ...
    },
    {
      exhibit_id: "EXH-003",
      item_description:
        "A crystalline residue sample collected from a spill between the keys of the victim's keyboard.",
      ...
      available_analyses: [
        {
          ...
          results: {
            summary:
              "The residue is crystallized coffee laced with Ricin, matching the contents of the smart mug (EXH-002). The sample also contains traces of a unique polymer used in a specific brand of hand lotion. Purchase records confirm Lisa Wong bought a bottle of this lotion last week.",
            is_conclusive: true,
          },
        },
      ],
...
const sceneData = [
  {
    contamination_risk: "MEDIUM",
    collection_location: "Library, Lord Ashworth Manor",
    exhibit_id: "EXH-001",
    available_analyses: [
      {
        results: {
          summary:
            "DNA analysis reveals a mixture of profiles, including the victim and an unknown individual.",
          unlocks_new_exhibits: ["EXH-006"],
          is_conclusive: false,
        },
        analysis_id: "DNA_ANALYSIS_001",
        analysis_type: "DNA_ANALYSIS",
      },
    ],
    item_description: "A bloodstained letter opener found near the victim.",
  },
  {
    collection_location: "Library, Lord Ashworth Manor",
    item_description: "A broken antique vase located near the victim’s body.",
    exhibit_id: "EXH-002",
    contamination_risk: "LOW",
    available_analyses: [
      {
        analysis_type: "FINGERPRINT_ANALYSIS",
        analysis_id: "FINGERPRINT_ANALYSIS_001",
        results: {
          summary:
            "Partial fingerprints found on the vase, insufficient for positive identification.",
          is_conclusive: false,
        },
      },
      {
        analysis_type: "CHEMICAL_ANALYSIS",
        analysis_id: "CHEMICAL_ANALYSIS_001",
        results: {
          is_conclusive: true,
          summary: "Traces of a rare perfume are detected on the vase.",
  ...
  {
    contamination_risk: "MEDIUM",
    item_description: "A torn piece of fabric found near the victim.",
    exhibit_id: "EXH-003",
    available_analyses: [
      {
        analysis_type: "FIBER_ANALYSIS",
        results: {
          is_conclusive: true,
          unlocks_new_exhibits: ["EXH-004"],
          summary: "Fibers consistent with a rare silk scarf are identified.",
        },
        analysis_id: "FIBER_ANALYSIS_001",
      },
    ],
    collection_location: "Library, Lord Ashworth Manor",
  },
  {
    exhibit_id: "EXH-004",
    item_description: "A rare silk scarf belonging to Lady Beatrice Ashworth.",
    collection_location: "Lady Beatrice’s bedroom, Lord Ashworth Manor",
    contamination_risk: "LOW",
    available_analyses: [
      {
        analysis_type: "DNA_ANALYSIS",
        analysis_id: "DNA_ANALYSIS_002",
        results: {
          is_conclusive: true,
          summary: "DNA on the scarf matches the victim.",
        },
      },
    ],
  },
    ...
    available_analyses: [
      {
        results: {
          summary:
            "Analysis confirms the perfume is extremely rare and expensive.",
          is_conclusive: true,
        },
        analysis_type: "CHEMICAL_ANALYSIS",
        analysis_id: "CHEMICAL_ANALYSIS_002",
      },
    ],
    item_description:
      "A bottle of perfume matching the trace found on the vase.",
    exhibit_id: "EXH-005",
    collection_location: "Lady Beatrice’s dressing table, Lord Ashworth Manor",
  },
  {
    contamination_risk: "MEDIUM",
    available_analyses: [
      {
        analysis_type: "DNA_ANALYSIS",
        analysis_id: "DNA_ANALYSIS_003",
        results: {
          is_conclusive: true,
          summary: "DNA on the handkerchief matches Mr. Edgar Ashworth.",
        },
      },
    ],
    item_description: "A handkerchief with a unique monogram.",
    collection_location: "Near the victim’s body.",
    exhibit_id: "EXH-006",
  },
];
